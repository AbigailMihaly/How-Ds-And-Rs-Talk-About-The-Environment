...
In this project, compleated as part of my work for the Columbia J School's Lede Program, I wanted to explore the topics of Congressional hearings in the top environment committees over time. Public Congressional hearings, especially the House, are an especially great proxy for overall political messaging; I wanted to see how that differed across party over time.
